...
// source: beeswax/logs/openrtb.proto
...
func (NativeRequest_LayoutId) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{2, 0} }
...
func (NativeRequest_AdUnitId) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{2, 1} }
...
func (NativeRequest_Asset_Image_ImageAssetType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor6, []int{2, 0, 1, 0}
}
...
func (NativeRequest_Asset_Data_DataAssetType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor6, []int{2, 0, 2, 0}
}
...
type BidRequest struct {
	...
	Allimps *Flag `protobuf:"varint,10,opt,name=allimps,enum=logs.Flag,def=0" json:"allimps,omitempty"`
	//
...
func (*BidRequest) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
type BidRequest_Impression struct {
	...
	Instl *Flag `protobuf:"varint,6,opt,name=instl,enum=logs.Flag,def=0" json:"instl,omitempty"`
	//
...
func (*BidRequest_Impression) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 0} }
...
type BidRequest_Impression_Banner struct {
	...
	// prominence.
	Pos *Enums_BidRequest_Impression_AdPosition `protobuf:"varint,4,opt,name=pos,enum=logs.Enums_BidRequest_Impression_AdPosition,def=0" json:"pos,omitempty"`
	//
	// Blocked creative types. If blank, assume all types are allowed.
	Btype []Enums_BidRequest_Impression_Banner_AdType `protobuf:"varint,5,rep,name=btype,enum=logs.Enums_BidRequest_Impression_Banner_AdType" json:"btype,omitempty"`
	//
	// Blocked creative attributes. If blank assume all types are allowed.
	Battr []CreativeAttribute `protobuf:"varint,6,rep,name=battr,enum=logs.CreativeAttribute" json:"battr,omitempty"`
	//
	...
	Topframe *Flag `protobuf:"varint,8,opt,name=topframe,enum=logs.Flag,def=0" json:"topframe,omitempty"`
	//
	// Specify properties for an expandable ad.
	Expdir []Enums_BidRequest_Impression_Banner_ExpandableDirection `protobuf:"varint,9,rep,name=expdir,enum=logs.Enums_BidRequest_Impression_Banner_ExpandableDirection" json:"expdir,omitempty"`
	//
	// List of supported API frameworks for this banner. If an API is not explicitly listed
	// it is assumed not to be supported.
	Api              []Enums_BidRequest_Impression_ApiFramework `protobuf:"varint,10,rep,name=api,enum=logs.Enums_BidRequest_Impression_ApiFramework" json:"api,omitempty"`
...
type BidRequest_Impression_Video struct {
	...
	Linearity *Enums_BidRequest_Impression_Video_Linearity `protobuf:"varint,2,opt,name=linearity,enum=logs.Enums_BidRequest_Impression_Video_Linearity,def=1" json:"linearity,omitempty"`
	//
	...
	Protocols []Enums_BidRequest_Impression_Video_Protocol `protobuf:"varint,5,rep,name=protocols,enum=logs.Enums_BidRequest_Impression_Video_Protocol" json:"protocols,omitempty"`
	//
	...
	//
	// Blocked creative attributes. If blank assume all types are allowed.
	Battr []CreativeAttribute `protobuf:"varint,10,rep,name=battr,enum=logs.CreativeAttribute" json:"battr,omitempty"`
	//
	...
	Boxingallowed *Flag `protobuf:"varint,14,opt,name=boxingallowed,enum=logs.Flag,def=1" json:"boxingallowed,omitempty"`
	//
	// List of allowed playback methods. If blank, assume that all are allowed.
	Playbackmethod []Enums_BidRequest_Impression_Video_PlaybackMethod `protobuf:"varint,15,rep,name=playbackmethod,enum=logs.Enums_BidRequest_Impression_Video_PlaybackMethod" json:"playbackmethod,omitempty"`
	//
	// List of supported delivery methods. If blank, assume all are supported.
	Delivery []Enums_BidRequest_Impression_Video_ContentDelivery `protobuf:"varint,16,rep,name=delivery,enum=logs.Enums_BidRequest_Impression_Video_ContentDelivery" json:"delivery,omitempty"`
	//
	// The position of the ad as a relative measure of visibility or prominence.
	Pos *Enums_BidRequest_Impression_AdPosition `protobuf:"varint,17,opt,name=pos,enum=logs.Enums_BidRequest_Impression_AdPosition,def=0" json:"pos,omitempty"`
	//
	...
	// List of supported API frameworks for this banner. If an API is not explicitly listed
	// it is assumed not to be supported.
	Api []Enums_BidRequest_Impression_ApiFramework `protobuf:"varint,19,rep,name=api,enum=logs.Enums_BidRequest_Impression_ApiFramework" json:"api,omitempty"`
	//
	// Recommended if companion objects are included.
	Companiontype    []Enums_BidRequest_Impression_Video_CompanionType `protobuf:"varint,20,rep,name=companiontype,enum=logs.Enums_BidRequest_Impression_Video_CompanionType" json:"companiontype,omitempty"`
...
type BidRequest_Impression_Native struct {
	...
	Api []Enums_BidRequest_Impression_ApiFramework `protobuf:"varint,3,rep,packed,name=api,enum=logs.Enums_BidRequest_Impression_ApiFramework" json:"api,omitempty"`
	// *
	// Blocked creative attributes. Refer to List 5.3.
	Battr            []CreativeAttribute `protobuf:"varint,4,rep,packed,name=battr,enum=logs.CreativeAttribute" json:"battr,omitempty"`
...
func (*BidRequest_Impression_Native) Descriptor() ([]byte, []int) {
	return fileDescriptor6, []int{0, 0, 2}
}
...
type BidRequest_Impression_PMP struct {
	...
	PrivateAuction *Flag `protobuf:"varint,1,opt,name=private_auction,json=privateAuction,enum=logs.Flag" json:"private_auction,omitempty"`
	//
...
func (*BidRequest_Impression_PMP) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 0, 3} }
...
func (*BidRequest_Impression_PMP_DirectDeal) Descriptor() ([]byte, []int) {
	return fileDescriptor6, []int{0, 0, 3, 0}
}
...
type BidRequest_Site struct {
	...
	Privacypolicy *Flag `protobuf:"varint,8,opt,name=privacypolicy,enum=logs.Flag" json:"privacypolicy,omitempty"`
	//
...
func (*BidRequest_Site) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 1} }
...
type BidRequest_App struct {
	...
	Privacypolicy *Flag `protobuf:"varint,9,opt,name=privacypolicy,enum=logs.Flag" json:"privacypolicy,omitempty"`
	//
	// Application is a paid version or free.
	Paid *Flag `protobuf:"varint,10,opt,name=paid,enum=logs.Flag" json:"paid,omitempty"`
	//
...
func (*BidRequest_App) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 2} }
...
type BidRequest_Content struct {
	...
	Videoquality *Enums_BidRequest_Content_VideoQuality `protobuf:"varint,8,opt,name=videoquality,enum=logs.Enums_BidRequest_Content_VideoQuality" json:"videoquality,omitempty"`
	//
	...
	Context *Enums_BidRequest_Content_Context `protobuf:"varint,12,opt,name=context,enum=logs.Enums_BidRequest_Content_Context" json:"context,omitempty"`
	//
	// Is content live?
	Livestream *Flag `protobuf:"varint,13,opt,name=livestream,enum=logs.Flag" json:"livestream,omitempty"`
	//
	// Direct or indirect.
	Sourcerelationship *Enums_BidRequest_Content_SourceRelationship `protobuf:"varint,14,opt,name=sourcerelationship,enum=logs.Enums_BidRequest_Content_SourceRelationship" json:"sourcerelationship,omitempty"`
	//
	// Content's Producer.
	...
	Qagmediarating *Enums_BidRequest_Content_QAGMediaRating `protobuf:"varint,17,opt,name=qagmediarating,enum=logs.Enums_BidRequest_Content_QAGMediaRating,def=-1" json:"qagmediarating,omitempty"`
	//
	...
	Embeddable *Flag `protobuf:"varint,18,opt,name=embeddable,enum=logs.Flag" json:"embeddable,omitempty"`
	//
...
func (*BidRequest_Content) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 3} }
...
type BidRequest_Device struct {
	//
	// Do Not Track.
	Dnt *Flag `protobuf:"varint,1,opt,name=dnt,enum=logs.Flag" json:"dnt,omitempty"`
	//
	...
	Js *Flag `protobuf:"varint,16,opt,name=js,enum=logs.Flag,def=1" json:"js,omitempty"`
	//
	// Return the detected data connection type for the device.
	Connectiontype *Enums_BidRequest_Device_ConnectionType `protobuf:"varint,17,opt,name=connectiontype,enum=logs.Enums_BidRequest_Device_ConnectionType,def=0" json:"connectiontype,omitempty"`
	//
	// Return the device type being used.
	Devicetype *Enums_BidRequest_Device_DeviceType `protobuf:"varint,18,opt,name=devicetype,enum=logs.Enums_BidRequest_Device_DeviceType,def=-1" json:"devicetype,omitempty"`
	//
...
func (*BidRequest_Device) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 4} }
...
func (*BidRequest_User) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 5} }
...
func (*BidRequest_Publisher) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 6} }
...
func (*BidRequest_Producer) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 7} }
...
func (*BidRequest_Geo) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 8} }
...
func (*BidRequest_Data) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 9} }
...
func (*BidRequest_Data_Segment) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 9, 0} }
...
type BidRequest_Regulations struct {
	...
	Coppa            *Flag                  `protobuf:"varint,1,opt,name=coppa,enum=logs.Flag" json:"coppa,omitempty"`
...
func (*BidRequest_Regulations) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 10} }
...
type BidResponse struct {
	...
	Nbr              *Enums_BidResponse_NoBidReason `protobuf:"varint,6,opt,name=nbr,enum=logs.Enums_BidResponse_NoBidReason" json:"nbr,omitempty"`
...
func (*BidResponse) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
type BidResponse_SeatBid struct {
	...
	Group            *Flag              `protobuf:"varint,3,opt,name=group,enum=logs.Flag" json:"group,omitempty"`
...
func (*BidResponse_SeatBid) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1, 0} }
...
type BidResponse_SeatBid_Bid struct {
	...
	Attr []CreativeAttribute `protobuf:"varint,11,rep,name=attr,enum=logs.CreativeAttribute" json:"attr,omitempty"`
	//
...
func (*BidResponse_SeatBid_Bid) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1, 0, 0} }
...
type NativeRequest struct {
	...
	// This field is not required, but it's highly recommended.
	Layout *NativeRequest_LayoutId `protobuf:"varint,2,opt,name=layout,enum=logs.NativeRequest_LayoutId" json:"layout,omitempty"`
	// *
	// The Ad unit ID of the native ad unit. This corresponds to one of IAB Core-6 native ad units.
	// This field is not required, but it's highly recommended.
	Adunit *NativeRequest_AdUnitId `protobuf:"varint,3,opt,name=adunit,enum=logs.NativeRequest_AdUnitId" json:"adunit,omitempty"`
	// *
...
func (*NativeRequest) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2} }
...
func (*NativeRequest_Asset) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2, 0} }
...
func (*NativeRequest_Asset_Title) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2, 0, 0} }
...
type NativeRequest_Asset_Image struct {
	...
	Type *NativeRequest_Asset_Image_ImageAssetType `protobuf:"varint,1,opt,name=type,enum=logs.NativeRequest_Asset_Image_ImageAssetType" json:"type,omitempty"`
	// *
...
func (*NativeRequest_Asset_Image) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2, 0, 1} }
...
type NativeRequest_Asset_Data struct {
	...
	Type *NativeRequest_Asset_Data_DataAssetType `protobuf:"varint,1,req,name=type,enum=logs.NativeRequest_Asset_Data_DataAssetType" json:"type,omitempty"`
	// *
...
func (*NativeRequest_Asset_Data) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2, 0, 2} }
...
func (*NativeResponse) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{3} }
...
func (*NativeResponse_Link) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{3, 0} }
...
func (*NativeResponse_Asset) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{3, 1} }
...
func (*NativeResponse_Asset_Title) Descriptor() ([]byte, []int) {
	return fileDescriptor6, []int{3, 1, 0}
}
...
func (*NativeResponse_Asset_Image) Descriptor() ([]byte, []int) {
	return fileDescriptor6, []int{3, 1, 1}
}
...
func (*NativeResponse_Asset_Data) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{3, 1, 2} }
...
func (*NativeResponse_Asset_Video) Descriptor() ([]byte, []int) {
	return fileDescriptor6, []int{3, 1, 3}
}
...
func init() {
	proto.RegisterType((*BidRequest)(nil), "logs.BidRequest")
	proto.RegisterType((*BidRequest_Impression)(nil), "logs.BidRequest.Impression")
	proto.RegisterType((*BidRequest_Impression_Banner)(nil), "logs.BidRequest.Impression.Banner")
	proto.RegisterType((*BidRequest_Impression_Video)(nil), "logs.BidRequest.Impression.Video")
	proto.RegisterType((*BidRequest_Impression_Native)(nil), "logs.BidRequest.Impression.Native")
	proto.RegisterType((*BidRequest_Impression_PMP)(nil), "logs.BidRequest.Impression.PMP")
	proto.RegisterType((*BidRequest_Impression_PMP_DirectDeal)(nil), "logs.BidRequest.Impression.PMP.DirectDeal")
	proto.RegisterType((*BidRequest_Site)(nil), "logs.BidRequest.Site")
	proto.RegisterType((*BidRequest_App)(nil), "logs.BidRequest.App")
	proto.RegisterType((*BidRequest_Content)(nil), "logs.BidRequest.Content")
	proto.RegisterType((*BidRequest_Device)(nil), "logs.BidRequest.Device")
	proto.RegisterType((*BidRequest_User)(nil), "logs.BidRequest.User")
	proto.RegisterType((*BidRequest_Publisher)(nil), "logs.BidRequest.Publisher")
	proto.RegisterType((*BidRequest_Producer)(nil), "logs.BidRequest.Producer")
	proto.RegisterType((*BidRequest_Geo)(nil), "logs.BidRequest.Geo")
	proto.RegisterType((*BidRequest_Data)(nil), "logs.BidRequest.Data")
	proto.RegisterType((*BidRequest_Data_Segment)(nil), "logs.BidRequest.Data.Segment")
	proto.RegisterType((*BidRequest_Regulations)(nil), "logs.BidRequest.Regulations")
	proto.RegisterType((*BidResponse)(nil), "logs.BidResponse")
	proto.RegisterType((*BidResponse_SeatBid)(nil), "logs.BidResponse.SeatBid")
	proto.RegisterType((*BidResponse_SeatBid_Bid)(nil), "logs.BidResponse.SeatBid.Bid")
	proto.RegisterType((*NativeRequest)(nil), "logs.NativeRequest")
	proto.RegisterType((*NativeRequest_Asset)(nil), "logs.NativeRequest.Asset")
	proto.RegisterType((*NativeRequest_Asset_Title)(nil), "logs.NativeRequest.Asset.Title")
	proto.RegisterType((*NativeRequest_Asset_Image)(nil), "logs.NativeRequest.Asset.Image")
	proto.RegisterType((*NativeRequest_Asset_Data)(nil), "logs.NativeRequest.Asset.Data")
	proto.RegisterType((*NativeResponse)(nil), "logs.NativeResponse")
	proto.RegisterType((*NativeResponse_Link)(nil), "logs.NativeResponse.Link")
	proto.RegisterType((*NativeResponse_Asset)(nil), "logs.NativeResponse.Asset")
	proto.RegisterType((*NativeResponse_Asset_Title)(nil), "logs.NativeResponse.Asset.Title")
	proto.RegisterType((*NativeResponse_Asset_Image)(nil), "logs.NativeResponse.Asset.Image")
	proto.RegisterType((*NativeResponse_Asset_Data)(nil), "logs.NativeResponse.Asset.Data")
	proto.RegisterType((*NativeResponse_Asset_Video)(nil), "logs.NativeResponse.Asset.Video")
	proto.RegisterEnum("logs.NativeRequest_LayoutId", NativeRequest_LayoutId_name, NativeRequest_LayoutId_value)
	proto.RegisterEnum("logs.NativeRequest_AdUnitId", NativeRequest_AdUnitId_name, NativeRequest_AdUnitId_value)
	proto.RegisterEnum("logs.NativeRequest_Asset_Image_ImageAssetType", NativeRequest_Asset_Image_ImageAssetType_name, NativeRequest_Asset_Image_ImageAssetType_value)
	proto.RegisterEnum("logs.NativeRequest_Asset_Data_DataAssetType", NativeRequest_Asset_Data_DataAssetType_name, NativeRequest_Asset_Data_DataAssetType_value)
}

func init() { proto.RegisterFile("beeswax/logs/openrtb.proto", fileDescriptor6) }

var fileDescriptor6 = []byte{
	// 3732 bytes of a gzipped FileDescriptorProto
	,
}
